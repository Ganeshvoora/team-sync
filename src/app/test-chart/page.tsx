...
export default function TestOrgChart() {
	return (
		<div className="w-full h-screen bg-gray-50 dark:bg-gray-900">
			<div className="absolute top-4 left-4 z-10 bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-white/10">
				<h3 className="text-gray-900 dark:text-white font-semibold mb-2">Edge Test Chart</h3>
				<p className="text-gray-600 dark:text-gray-300 text-sm">
					This should show visible edges connecting the nodes
				</p>
