...
export default function TaskStats({ tasks, currentUser }: TaskStatsProps) {
  ...
  return (
    <div className="space-y-6 mb-6">
      {/* Overall Statistics */}
      <div>
        <h3 className="text-lg font-semibold text-white mb-3">Task Overview</h3>
      ...
      {/* Personal Statistics */}
      <div>
        <h3 className="text-lg font-semibold text-white mb-3">My Performance</h3>
            ...
            <Card key={index} className="bg-white/10 backdrop-blur-xl border-white/20">
              <CardContent className="p-4">
                <div className="text-center">
                  ...
                  <p className="text-xs text-green-200">{stat.subtitle}</p>
                </div>
              </CardContent>
            </Card>
          ))}
      ...
      {/* Priority Distribution */}
      <div>
        <h3 className="text-lg font-semibold text-white mb-3">Priority Distribution</h3>
        <Card className="bg-white/10 backdrop-blur-xl border-white/20">
          <CardContent className="p-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="text-center">
                <div className="bg-red-500/20 text-red-300 p-3 rounded-lg mb-2">
                  <p className="text-xl font-bold">{urgentTasks.length}</p>
                </div>
                <p className="text-sm text-red-300">Urgent</p>
              </div>
              <div className="text-center">
                <div className="bg-orange-500/20 text-orange-300 p-3 rounded-lg mb-2">
                  <p className="text-xl font-bold">{highTasks.length}</p>
                </div>
                <p className="text-sm text-orange-300">High</p>
              </div>
              <div className="text-center">
                <div className="bg-yellow-500/20 text-yellow-300 p-3 rounded-lg mb-2">
                  <p className="text-xl font-bold">{mediumTasks.length}</p>
                </div>
                <p className="text-sm text-yellow-300">Medium</p>
              </div>
              <div className="text-center">
                <div className="bg-green-500/20 text-green-300 p-3 rounded-lg mb-2">
